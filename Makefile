#############################################################################
# Makefile for building: SpaceCat
# Generated by qmake (3.1) (Qt 5.15.1)
# Project:  SpaceCat.pro
# Template: app
# Command: C:\Qt\5.15.1\mingw81_64\bin\qmake.exe -o Makefile SpaceCat.pro -spec win32-g++ "CONFIG+=debug"
#############################################################################
...
Makefile: SpaceCat.pro C:/Qt/5.15.1/mingw81_64/mkspecs/win32-g++/qmake.conf C:/Qt/5.15.1/mingw81_64/mkspecs/features/spec_pre.prf \
